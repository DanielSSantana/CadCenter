...
namespace APICadCenter.Servico
{
    ...
    {
        long Criar(string nome, string cpf, string telefone, string email);
        Pessoa BuscarPorId(long Id);
        List<Pessoa> Buscar(int pagina = 1, int tamanhoPagina = 10);
        void AtualizarPropriedade(long Id, string? nome = null, string? telefone = null, string? email = null);
        void Exluir(long Id);
